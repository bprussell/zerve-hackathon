...
# ── App Page 3: DiD Coefficient Plot (self-contained, hardcoded) ──
# No upstream dependencies — results hardcoded from Track A analysis
...
coef_fig, ax = plt.subplots(figsize=(9, 3.5), dpi=120)
...
coef_fig.suptitle("EAB Impact on Golf Scores", fontsize=16, fontweight="bold", y=1.02)
...
print(f"Coefficient plot: {coef_val:.2f} strokes (p = {p_val:.3f})")

del ax, coef_val, se_val, p_val, ci_lo, ci_hi, ORANGE
